...
fn update_selection_visuals(
    ...
    mut border_query: Query<(&SelectedBorder, &mut BorderColor, &mut BackgroundColor), Without<PreviewPanel>>,
    mut preview_query: Query<&mut BackgroundColor, With<PreviewPanel>>,
    mut name_query: Query<&mut Text, (With<LevelNameText>, Without<ObjectiveText>, Without<DescriptionText>)>,
    mut objective_query: Query<&mut Text, (With<ObjectiveText>, Without<LevelNameText>, Without<DescriptionText>)>,
    mut lore_query: Query<&mut Text, (With<DescriptionText>, Without<LevelNameText>, Without<ObjectiveText>)>,
) {
